...
def test_terrain_clamps_against_the_shader_constant_not_a_literal():
    source = open(os.path.join(os.path.dirname(__file__), '..', 'terrain.py')).read()
...
def test_the_renderer_and_the_settings_window_ask_the_same_question():
    ...
    renderer_src = open(os.path.join(os.path.dirname(__file__), '..',
                                     'renderer_core.py')).read()
    settings_src = open(os.path.join(os.path.dirname(__file__), '..', '..',
                                     'editor', 'SettingsWindow.py')).read()
